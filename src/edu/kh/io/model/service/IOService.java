...
public class IOService {
	...
	public void output1() {
		...
		// FileNotFoundException / IOExcepsion 예외가 발생할 가능성이 있음 -> 예외 처리 필요
		try {
			
			fos = new FileOutputStream("tesr1.txt");
			...
			for(int i = 0; i < str.length(); i++) {
				...
				// write()는 IOEmxception을 발생시킬 가능성이 있다.
			}
